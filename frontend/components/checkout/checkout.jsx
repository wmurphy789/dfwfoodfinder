...
class Checkout extends React.Component {
  ...
  componentDidMount() {
    this.calculateTotal();
    this.props.fetchVendor(this.props.vendorId);
  }
  
  calculateTotal() {
    let { bookingParams } = this.props;
    let numDays = moment(bookingParams.end_date).diff(bookingParams.start_date, 'days');
    let bookingSubtotal = parseFloat((this.props.vendor.price * numDays));
  ...
  handleSubmit(e) {
    ...
    let bookingParams = {
      ...
      vendor_id: this.props.bookingParams.vendor_id,
  ...
  render() {
    let { currentUser, vendor, bookingParams } = this.props;
    if (this.state.loading || !vendor) {
      return (
              ...
              <div className="checkout__sidebar-recap-wrapper">
                <div className="checkout__sidebar-recap-desc-wrapper">
                  ...
                  <p className="checkout__sidebar-recap-text">
                      {vendor.vendor_type[0].toUpperCase()}{vendor.vendor_type.slice(1)} in {vendor.location}
                  </p>
                ...
                <div className="checkout__sidebar-recap-photo-wrapper">
                    <div className="checkout__sidebar-recap-photo" style={{ backgroundImage: `url(${vendor.thumbnailUrls[0]})`}}></div>
                </div>
              </div>
                ...
                <div className="checkout__sidebar-fees-wrapper">
                  <div className="checkout__sidebar-fees-row">
                      <p className="checkout__sidebar-fees-content">
                        ${vendor.price} x <Moment duration={bookingParams.start_date} date={bookingParams.end_date} />
                      </p>

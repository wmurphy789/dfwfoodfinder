...
export const RECEIVE_BOOKINGS_BY_VENDOR_ID = 'RECEIVE_BOOKINGS_BY_VENDOR_ID';
...
const receiveBookingsByVendorId = bookings => {
  return ({
    type: RECEIVE_BOOKINGS_BY_VENDOR_ID,
    bookings: bookings
  });
} 
...
export const fetchBookingsByVendorId = vendorId => dispatch => {
  return BookingApiUtil.fetchBookingsByVendorId(vendorId)
    .then(bookings => dispatch(receiveBookingsByVendorId(bookings)));
}
